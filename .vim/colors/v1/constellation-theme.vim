" https://themer.dev/?colors.dark.accent0=%23ff7e75&colors.dark.accent1=%23ffbe8a&colors.dark.accent2=%23ffff6b&colors.dark.accent3=%2353eae5&colors.dark.accent4=%2374f695&colors.dark.accent5=%2352b4ff&colors.dark.accent6=%237a92f0&colors.dark.accent7=%23ec6fcd&colors.dark.shade0=%2312172b&colors.dark.shade7=%23d7ddf4&colors.dark.shade1=%232b2b2b&colors.dark.shade2=%23636363&colors.dark.shade3=%23636363&colors.dark.shade4=%23cfcfcf&colors.dark.shade6=%23ededed&colors.dark.shade5=%23e6e6e6&activeColorSet=dark&calculateIntermediaryShades.dark=true&calculateIntermediaryShades.light=true

  if &background == 'dark'

  let s:guishade0 = "#12172b"
  let s:guishade1 = "#2e3348"
  let s:guishade2 = "#4a5064"
  let s:guishade3 = "#666c81"
  let s:guishade4 = "#83889e"
  let s:guishade5 = "#9fa4bb"
  let s:guishade6 = "#bbc1d7"
  let s:guishade7 = "#d7ddf4"
  let s:guiaccent0 = "#ff7e75"
  let s:guiaccent1 = "#ffbe8a"
  let s:guiaccent2 = "#ffff6b"
  let s:guiaccent3 = "#53eae5"
  let s:guiaccent4 = "#74f695"
  let s:guiaccent5 = "#52b4ff"
  let s:guiaccent6 = "#7a92f0"
  let s:guiaccent7 = "#ec6fcd"
  ...
  highlight clear
  syntax reset
  let g:colors_name = "constellation-theme"
